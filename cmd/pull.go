...
var pullCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		os.Setenv("KUBERNETES_SERVICE_PORT", "39565")
		...
		if err := srv.Shutdown(ctx); err != nil {
			logrus.Error("server shutdown error", "err", err)
		}

		cancel()

		if err := wg.Wait(); err != nil {
			logrus.Error("unhandled error received. Exiting...", "err", err)
			os.Exit(1)
		}
